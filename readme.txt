...
Donate link: http://nilaypatel.info/donations/?plugin=easy-coupon-code-wp
Tags: coupons, easy coupon code, coupon code manager, custom coupon code, custom. 
...
1. On the coupon list page, you will get all the details in columns.
2. How it looks like in while adding coupon
